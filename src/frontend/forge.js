...
(function () {
    ...
    window.__forge__ = {
        ...
        window: {
            ...
            setVibrancy: function (effect) {
                return window.__forge__.invoke("__forge_window_set_vibrancy", {
                    effect: effect || null
                });
            },
            position: function () {
        ...
        shortcuts: {
            register: function (accelerator) {
                return window.__forge__.invoke("shortcuts_register", { accelerator: accelerator });
            },
            unregister: function (accelerator) {
                return window.__forge__.invoke("shortcuts_unregister", { accelerator: accelerator });
            },
            unregisterAll: function () {
                return window.__forge__.invoke("shortcuts_unregister_all", {});
            }
        },

        lifecycle: {
            requestSingleInstanceLock: function (instanceName) {
                return window.__forge__.invoke("request_single_instance_lock", {
                    instance_name: instanceName || null
                });
            },
            relaunch: function () {
                return window.__forge__.invoke("relaunch", {});
            }
        },

        power: {
            getBatteryInfo: function () {
                return window.__forge__.invoke("get_battery_info", {});
            }
        },

        screen: {
            getMonitors: function () {
                return window.__forge__.invoke("get_monitors", {});
            },
            getPrimaryMonitor: function () {
                return window.__forge__.invoke("get_primary_monitor", {});
            },
            getCursorScreenPoint: function () {
                return window.__forge__.invoke("get_cursor_screen_point", {});
            }
        },

        keychain: {
            setPassword: function (key, password) {
                return window.__forge__.invoke("set_password", { key: key, password: password });
            },
            getPassword: function (key) {
                return window.__forge__.invoke("get_password", { key: key });
            },
            deletePassword: function (key) {
                return window.__forge__.invoke("delete_password", { key: key });
            }
        },

        osIntegration: {
            setProgressBar: function (progress) {
                return window.__forge__.invoke("set_progress_bar", { progress: progress });
            },
            requestUserAttention: function (isCritical) {
                return window.__forge__.invoke("request_user_attention", { is_critical: !!isCritical });
            },
            clearUserAttention: function () {
                return window.__forge__.invoke("clear_user_attention", {});
            }
        },

        autostart: {
            enable: function () {
                return window.__forge__.invoke("enable", {});
            },
            disable: function () {
                return window.__forge__.invoke("disable", {});
            },
            isEnabled: function () {
                return window.__forge__.invoke("is_enabled", {});
            }
        },

        printing: {
            printPage: function () {
                return window.__forge__.invoke("print_page", {});
            }
        },
